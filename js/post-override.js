...
ajaxSettings: {
				...
				global : true,
				type : "GET",
				contentType: "application/x-www-form-urlencoded; charset=ISO-8859-1",// or ISO-8859-1
				processData : true,
				async : true,
				/*
			...
			ajax : function(origSettings) {
				...
				var jsonp, status, data, callbackContext = origSettings
						&& origSettings.context || s, type = s.type
						.toUpperCase();
				...
				// Send the data
				try {
					xhr.send(type === "POST" || type === "PUT"
							|| type === "DELETE" ? s.data : null);
				} catch (e) {
